...
void BackgroundWorker::setNeedTrackingDevice(bool need_tracking)
{
    m_need_tracking_device = need_tracking;
}
...
void BackgroundWorker::run()
{
    ...
    try
    {
        ...
        if (m_need_tracking_device) {
            DeviceTrackingCmdMacro dev_tracking_cmd_macro;
            dev_tracking_cmd_macro.execute(conn, cbs.trans);
        }
#endif
