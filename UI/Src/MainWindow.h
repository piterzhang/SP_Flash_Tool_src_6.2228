...
private slots:
    ...
    void on_actionDownload_Cert_triggered();
    ...
    void slot_show_network_connected(NetworkInft::network_con_changed_src con_changed_src);
...
private:
    ...
    void updateNetworkActionVisible();
