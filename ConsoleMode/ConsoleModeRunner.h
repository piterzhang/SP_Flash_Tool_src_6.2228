...
public:
    ...
    void execute(const Config &config, const ConsoleModeNetworkIntf *p_consoleModeNetworkIntf) const;
...
public:
    ...
    static void cbWriteMemoryProgress(void *_this, unsigned int progress,
                                 unsigned long long data_xferd, const QString &info);
    static void cbDLCertProgress(void *_this, unsigned int progress,
                                 unsigned long long data_xferd, const QString &info);
