...
public:
    CommandSetting();
    CommandSetting(bool reboot_to_atm, const QString &flash_xml_file, bool need_storage_life_chk);
...
private:
    ...
    cmd_wrapper_ptr createDLCertCmdWrapper() const;
...
private:
    ...
    bool m_is_firmware_upgrade_op;
    bool m_need_storage_life_check;
};
