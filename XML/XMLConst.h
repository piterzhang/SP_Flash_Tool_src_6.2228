...
#define ENABLE_PHONE_TRACKING_NAME "phone_tracking_en"
...
#define OP_TYPE_NODE_NAME "operation_type"
#define BINREGION_TYPE QStringLiteral("BINREGION")
#define PROTECTED_TYPE QStringLiteral("PROTECTED")
...
#define DA_HRID_VAL_NAME QStringLiteral("DA.HRID")
#define DA_SEG_CODE_VAL_NAME QStringLiteral("DA.SEG_CODE")
...
#define DL_CERT_CMD_NAME          QStringLiteral("download-cert")
